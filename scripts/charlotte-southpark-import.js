...
const AREAS = [
  { label: "SouthPark", lat: 35.1516, lng: -80.8320, radius: 1500 },
];
...
const EXCLUDE = /chick-fil-a|mcdonald|taco bell|krispy kreme|chipotle|cook out|quiktrip|starbucks|dunkin|subway|wendy|burger king|popeyes|bojangles|hardee|arby|panera|jersey mike|jimmy john|food truck|\bcoffee\b|gas station|7-eleven|circle k|sheetz|\bwawa\b|five guys|penn station|chef alyssa|table & twine|table and twine|\btienda\b|kabab 2 go|meal prep|naked farmer|dulce y salado|el sartenazo|las delicias|donde nanchis|family crepes|\bla fogata\b|mi pais|pei wei|sarku|charleys cheesesteak|showmars|marketplace cafe|original pancake|cheesecake factory|p\.?f\.? ?chang|maggiano|tiger thai/i;
// Mall food-court stalls sit in SouthPark Mall suites (Spc/Vc/food court).
const EXCLUDE_ADDR = /Yeoman Rd|Sharon Rd (Vc|Spc G|Suite G)/i;
